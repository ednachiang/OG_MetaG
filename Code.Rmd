...
# Test w/ ANOVA
summary(aov(PropCAZyme ~ Season, data = prodigalCounts))
  # p-value = 0.0184

# Posthoc test w/ Tukey's
TukeyHSD(aov(PropCAZyme ~ Season, data = prodigalCounts))
  # Winter-Summer = 0.0422137*
  # Spring-Summer = 0.0208430*
  # Spring-Winter = 0.8259681
  



### Boxplot
ggplot(prodigalCounts, aes(x=Season, y=PropCAZyme, fill=Season)) +
  geom_boxplot(position=position_dodge(1)) +
  geom_point(position=position_dodge(width = 0.2), size=2) +
  ylab("CAZyme Proportion (%)") +
  scale_fill_manual(values=c("darkgoldenrod2", "dodgerblue3", "green3")) +
  scale_y_continuous(breaks = c(3.1, 3.2, 3.3, 3.4, 3.5, 3.6, 3.7, 3.8, 3.9), limits=c(3.1, 3.9)) +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank())
...
sw.dbcan <- subset_samples(dbcan.phy, Season != "Spring")
sp.dbcan <- subset_samples(dbcan.phy, Season != "Winter")
wp.dbcan <- subset_samples(dbcan.phy, Season != "Summer")
...
dbcan.sig <- subset_taxa(dbcan.phy, Family == "GH101" | Family == "PL1" | Family == "GH43" | 
                           Family == "GH115" | Family == "PL9" | Family == "CE12" | Family == "GH10" |
                           Family == "GH3" | Family == "GH32" | Family == "GH5" | Family == "GH51" |
                           Family == "GH36" | Family == "GH25" | Family == "GH78" | Family == "GH42" |
                           Family == "GH129" | Family == "GH106" | Family == "GH39" | Family == "GH59" |
                           Family == "GH14" | Family == "PL22" | Family == "GH41" | Family == "GH20" |
                           Family == "GT4" | Family == "GH92" | Family == "GT9" | Family == "GT30" |
                           Family == "CE11" | Family == "GH57" | Family == "GT3" | Family == "GH84")


#tiff("dbcan.heatmap.tiff", width=9, height=10, units="in", res=300)
plot_heatmap(dbcan.sig, sample.label = "Season", sample.order = c("3715", "3717", "3744", "3723", "3733", "3772", "3734", "3773", "3775"), taxa.order = c("PL22", "CE11", "GT41", "GT30", "GT9", "GT4", "GT3", "GH92", "GH84", "GH57", "GH20", "GH129", "GH106", "GH78", "GH59", "GH51", "GH42", "GH39", "GH36", "GH32", "GH25", "GH14", "GH5", "GH3", "PL9", "PL1", "CE12", "GH115", "GH43", "GH10", "GH101")) +
  ...
  xlab("Season\n\n") +
  ylab("CAZyme Family\n\n") +
  scale_fill_gradientn(name=expression("Mean Normalized Counts"), limits=c(0,1400),
