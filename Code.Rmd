...
cog.su.wi.sig <- cog.res.su.wi[which(cog.res.su.wi$padj < 0.5),]
...
cog.su.wi.sum <- rownames(cog.su.wi.sig[cog.su.wi.sum.sig,])
  # Summer
  # "COG0381" "COG0405" "COG0683" "COG0684" "COG0728" "COG1038" "COG1178" "COG1250" "COG1288" "COG1775" "COG1788" "COG1840" "COG2057" "COG2828" "COG2964" "COG3246" "COG3314" "COG4968" "COG5659"
cog.su.wi.win.sig <- which(cog.su.wi.sig.df$log2FoldChange > 0)
cog.su.wi.win <- rownames(cog.su.wi.sig[cog.su.wi.win.sig,])
  # Winter
  # "COG0004" "COG0134" "COG0135" "COG0159" "COG0243" "COG0246" "COG0417" "COG0547" "COG0722" "COG1051" "COG1061" "COG1070" "COG1105" "COG1132" "COG1204" "COG1472" "COG1501" "COG1511" "COG1609" "COG1621" "COG1653" "COG1835" "COG1874" "COG2182" "COG2207" "COG2703" "COG2730" "COG2755" "COG2816" "COG2972" "COG3153" "COG3250" "COG3345" "COG3464" "COG3507" "COG3533" "COG3534" "COG3561" "COG3635" "COG3661" "COG3693" "COG3757" "COG3866" "COG3940" "COG3973" "COG4086" "COG4209" "COG4225" "COG4284" "COG4585" "COG4642" "COG4677" "COG4806" "COG4870" "COG5021" "COG5077" "COG5272" "COG5434"

# Summer vs. Spring
cog.res.su.sp <- results(cog.de, contrast=c("Season", "Spring", "Summer"), pAdjustMethod = "BH")
cog.su.sp.sig <- cog.res.su.sp[which(cog.res.su.sp$padj < 0.5),]
...
cog.sp.wi.sig <- cog.res.su.sp[which(cog.res.sp.wi$padj < 0.5),]
...
pheatmap(cog.dist.matrix, clustering_distance_rows=cog.dist, clustering_distance_cols=cog.dist,
         col=colors, annotation_rows=T, annotation_cols=T)
