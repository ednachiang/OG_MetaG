...
gen.GH20.combined$SD[5] = sd(gen.GH20.total$Mean[13:5])
...
gen.GH20.combined$SE[5] = (sd(gen.GH20.total$Mean[13:5])/3)

  
# Barplot for top 5 genera - All seasons combined
#tiff("GH20.class.tiff", width=7, height=5, units="in", res= 300)
...
gen.GH84.combined$SD[5] = sd(gen.GH84.total$Mean[13:5])
...
gen.GH84.combined$SE[5] = (sd(gen.GH84.total$Mean[13:5])/3)

  
# Barplot for top 5 genera - All seasons combined
#tiff("GH84.class.tiff", width=7, height=5, units="in", res= 300)
...
gen.GT3.combined$SD[5] = sd(gen.GT3.total$Mean[13:5])
...
gen.GT3.combined$SE[5] = (sd(gen.GT3.total$Mean[13:5])/3)

  
# Barplot for top 5 genera - All seasons combined
tiff("GT3.class.tiff", width=7, height=5, units="in", res= 300)
