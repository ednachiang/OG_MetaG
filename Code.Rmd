...
mad(log(mcols(dbcan.par)$dispGeneEst) - log(mcols(dbcan.par)$dispFit))
  # 7.565014
# Parametric fit is less spread out (small residual) compared to local fit
# I'll stick with the DESeq2 defaults (test = Wald, fitType = Parametric)
...
# Excluding GT4 because it has such high counts that it makes the heatmap hard to interpret visually
# I'll make a separate plot for just GT4
dbcan.sig <- subset_taxa(dbcan.fam.norm.phy, Family == "GH101" | Family == "PL1" | Family == "GH43" | 
                           ...
                           Family == "GH92" | Family == "GT9" | Family == "GT30" | Family == "CE11" |
                           Family == "GH57" | Family == "GT3" | Family == "GH84")


#tiff("dbcan.heatmap.tiff", width=9, height=10, units="in", res=300)
plot_heatmap(dbcan.sig, sample.label = "Season", sample.order = c("3715", "3717", "3744", "3723", "3733", "3772", "3734", "3773", "3775"), taxa.order = c("PL22", "CE11", "GT41", "GT30", "GT9", "GT3", "GH92", "GH84", "GH57", "GH20", "GH129", "GH106", "GH78", "GH59", "GH51", "GH42", "GH39", "GH36", "GH32", "GH25", "GH14", "GH5", "GH3", "PL9", "PL1", "CE12", "GH115", "GH43", "GH10", "GH101")) +
  ...
  xlab("Season\n\n") +
  ylab("CAZyme Family\n\n") +
  scale_fill_gradientn(name=expression("Normalized Counts"), limits=c(0,610),
...
### GT4 plot
dbcan.GT4 <- subset_taxa(dbcan.fam.norm.phy, Family == "GT4" | Family=="GH101")
  # plot_heatmap doesn't work on just 1 group, so I added GH101
  # Remove GH101 after running code
#tiff("dbcan.GT4.heatmap.tiff", width=9, height=2, units="in", res=300)
plot_heatmap(dbcan.GT4, sample.label = "Season", sample.order = c("3715", "3717", "3744", "3723", "3733", "3772", "3734", "3773", "3775"), taxa.order = c("GH101", "GT4")) +
  geom_tile(colour="gray40") +
  scale_x_discrete(position = "top", labels=c("Summer", "Summer", "Summer", "Winter", "Winter", "Winter", "Spring", "Spring", "Spring")) +
  xlab("Season\n\n") +
  geom_text(size=4, aes(label=sprintf("%0.2f", round(Abundance, digits=2))))+
  scale_fill_gradientn(name=expression("Normalized Counts"), limits=c(850,1200),
                       breaks=c(850, 1025, 1200), 
                       labels=c("850", "1025", "1200"),
                       colours = c("#FFFFFF", "#ffffcc", "#ffeda0", "#fed976", "#feb24c", "#fd8d3c",
                                   "#fc4e2a", "#e31a1c", "#bd0026", "#800026")) +
   theme(axis.text.x = element_blank(),
        axis.text.y = element_text(size=20),
...
muc.enz <- c("GH2", "GH3", "GH16", "GH18", "GH20", "GH27", "GH29", "GH31", "GH33", "GH35", "GH36", "GH38", "GH42", "GH84", "GH85", "GH89", "GH92", "GH95", "GH101", "GH109", "GH123", "GH125", "GH129", "GH163")
...
TukeyHSD(aov(Total_MucinDeg ~ Season, data = muc.sum.df))
  # Winter-Summer = 0.2278598
  # Spring-Summer = 0.0039594*
  # Spring-Winter = 0.0281509*
