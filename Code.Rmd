...
colnames(cog.norm) <- c("3715", "3717", "3723", "3733", "3734", "3744", "3772", 
                        "3773", "3775")
cog.dist <- dist(t(cog.norm))
cog.dist.matrix <- as.matrix(cog.dist)
rownames(cog.dist.matrix) <- cog.df$Season
colnames(cog.dist.matrix) <- cog.df$Season
...
### PCA
cog.pca.data <- plotPCA(cog.norm, intgroup = "Season", returnData = T)
