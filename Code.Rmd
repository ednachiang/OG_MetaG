...
tiff("kegg_DESeq.tiff", width=6, height=6, units="in", res=600)
pheatmap(kegg.ntd.assay.order, cluster_rows=F, show_rownames=F, cluster_cols=F, treeheight_col = 0,
         show_colsnames=F, border_color = "gray40", fontsize = 14, width = 3, height=3,
         ...
         annotation_col=kegg.de.df,
         annotation_colors = list(Season = c(Summer = "#00cccc", Winter = "#008484", Spring = "#004f4f"))
)
dev.off()


tiff("kegg_DESeq1.tiff", width=3, height=3, units="in", res=600)
pheatmap(kegg.ntd.assay.order, cluster_rows=F, show_rownames=F, cluster_cols=F, show_colsnames=F, 
...
kegg.ntd$X <- ordered(kegg.ntd$X, levels=c("3715", "3717", "3744", "3723", "3733", "3772", "3734", "3773", "3775"))
tiff("kegg_DESeq.tiff", width=4, height=4, units="in", res=600)
test <- pheatmap(assay(kegg.ntd)[kegg.select,], cluster_rows=F, show_rownames=T, cluster_cols=F, treeheight_col = 5,labels_col = c("Summer", "Summer", "Winter", "Winter", "Spring", "Summer", "Winter", "Spring", "Spring"),
...
tiff("COG_DESeq.tiff", width=6, height=6, units="in", res=600)
...
tiff("COG_DESeq1.tiff", width=3, height=3, units="in", res=600)
pheatmap(cog.ntd.assay.order, cluster_rows=F, show_rownames=F, cluster_cols=F, show_colsnames=F, 
         border_color = "gray40", fontsize = 14, width = 3, height=3,
         color = colorRampPalette(rev(brewer.pal(9, "YlOrRd")))(255)
)
dev.off()

test <- pheatmap(cog.ntd.assay.order, cluster_rows=F, show_rownames=F, cluster_cols=F, treeheight_col = 0, 
         border_color = "gray40", fontsize = 14, width = 3, height=3,
         color = colorRampPalette(rev(brewer.pal(9, "YlOrRd")))(255),
         labels_col = c("Summer", "Summer", "Summer", "Winter", "Winter", "Winter", "Spring", "Spring", "Spring"),
         annotation_col=cog.de.df,
...
tiff("COG_DESeq.tiff", width=3, height=3, units="in", res=600)
pheatmap(assay(cog.ntd)[select,], cluster_rows=F, show_rownames=F, cluster_cols=F, treeheight_col = 0, 
         border_color = "gray40", fontsize = 14, width = 3, height=3,
         color = colorRampPalette(rev(brewer.pal(9, "YlOrRd")))(255)
         )
dev.off()
