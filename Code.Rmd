...
# Plot barplot
class.plot <- ggplot(dbcan.class.sum, aes(x=Season, y=Mean, fill=Season)) +
  geom_bar(stat="identity", color="black") +
  geom_errorbar(aes(ymax=Mean+SE, ymin=Mean-SD), width=0.25) +
...
pairwise.adonis(as.matrix(t(otu_table(dbcan99))), meta$Season, sim.method="bray", p.adjust.m="fdr")
  # Summer-Winter: adj-pval=0.15, R2 = 0.4418498
  # Summer-Spring: adj-pval=0.2, R2 = 0.3490680
  # Winter-Spring: adj-pval=0.15, R2 = 0.5788924
