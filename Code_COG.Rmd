...
#cog.cat.dds <- cog.cat.dds[rowSums(counts(cog.cat.dds)) > 1,]
#cog.cat.local <- DESeq(cog.cat.dds, fitType = "local")
#cog.cat.par <- DESeq(cog.cat.dds, fitType = "parametric")
  # Local was automatically substituted because parametric isn't a good fit
