# https://github.com/alekseyenko/Tw2/blob/master/code/Tw2.R
# From paper: Alekseyenko, A. V. (2016) Multivariate Welch t-test on distances. Bioinformatics, 32(23), 3552-3558. doi: 10.1093/bioinformatics/btw524
