...
import.class <- function(x,y) {
  n <- as.numeric(length(list.files(x)))
  # Initialize output dataframe
  class <- data.frame(matrix(ncol=5, nrow=170))
  ...
  for (i in 1:n) {
    ...
    if (i < 2){
      ...
      class <- full_join(phylum, df, by=c("Domain", "Phylum", "Class"))
    ...
    class[which(phylum$Domain == "unclassified"),3:20] <- c(0, 4515088, 0, 7511409, 0, 5341407, 0, 5784901, 0, 8807662, 0, 6258991, 0, 4868461, 0, 7159963, 0, 6928969)
